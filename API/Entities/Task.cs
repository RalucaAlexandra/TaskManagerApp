...
namespace API.Entities
{
    public class Task
    {
        ...
        public int CreatedBy { get; set; } //FK, refers to "AspNetUsers" table, indicating who created the task
        public int AssignedTo { get; set; } //FK, refers to "AspNetUsers" table, indicating to whom the task is assigned
